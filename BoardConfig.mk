...
LOCAL_PATH := device/alcatel/9010x
...
BOARD_MKBOOTIMG_ARGS  := --kernel_offset 0x00008000 --ramdisk_offset 0x04000000 --tags_offset 0x0e000000 --board vAAL-0
TARGET_PREBUILT_KERNEL := device/alcatel/9010x/kernel
...
# RECOVERY
TARGET_RECOVERY_FSTAB := device/alcatel/9010x/twrp.fstab
